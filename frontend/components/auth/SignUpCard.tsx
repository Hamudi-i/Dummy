    ...
    <div id="colab-signup-card-container" className="relative z-10 select-none">
      ...
      <div className="card-container min-h-[420px]">
        ...
        <div className="card-inner py-3.5">
          ...
          {/* Divider */}
          <div className="w-[180px] flex flex-col items-center mt-3.5 mb-2">
            <div className="w-full h-[1px] bg-[#C5C0B4]"></div>
            <span className="text-[12.5px] font-comic text-[#75726B] -mt-2.5 bg-[#FBF8EF] px-2">
              Or sign up with
            </span>
          </div>
          ...
          <div className="flex items-center space-x-2 mt-0.5">
            ...
            <button
              id="colab-signup-social-github-btn"
              type="button"
              onClick={() => onSocialLogin('GitHub')}
              className="social-btn-compact"
              title="Sign up with GitHub"
            >
              <svg width="20" height="20" viewBox="0 0 24 24" fill="#30312C">
            ...
            <button
              id="colab-signup-social-apple-btn"
              type="button"
