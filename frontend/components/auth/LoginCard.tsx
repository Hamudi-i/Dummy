...
export const LoginCard: React.FC<LoginCardProps> = ({
  ...
  return (
    <div id="colab-login-card-container" className="relative z-10 select-none">
      ...
      <div className="absolute w-[352px] sm:w-[360px] h-full min-h-[450px] bg-[#30312C] rounded-[18px] border-[2.2px] border-[#30312C] pointer-events-none translate-x-[8px] translate-y-[8px] opacity-25 z-0" />
