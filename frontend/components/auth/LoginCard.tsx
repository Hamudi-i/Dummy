...
export const LoginCard: React.FC<LoginCardProps> = ({
  ...
  return (
    <div id="colab-login-card-container" className="relative z-10 select-none">
      {/* Hand-Drawn Flat Solid Shadow (Card) */}
      <div className="absolute w-[352px] sm:w-[360px] h-full min-h-[440px] bg-[#30312C] rounded-[18px] border-[2.2px] border-[#30312C] pointer-events-none translate-x-[8px] translate-y-[8px] opacity-25 z-0" />

      {/* Outer Cardboard/Wooden Frame */}
      <div className="card-container min-h-[440px]">
        ...
        <div className="card-inner py-5">
          ...
          <div className="relative flex flex-col items-center mb-3">
            <h2 className="heading-primary leading-tight">
              Let&apos;s Get Started!
            </h2>
            <svg width="132" height="8" viewBox="0 0 100 6" fill="none" className="mt-0.5">
              <path d="M 2 3 C 25 5 75 5 98 2" stroke="#E27D56" strokeWidth="2.2" strokeLinecap="round" />
            </svg>
          </div>
          ...
          <form onSubmit={handleSubmit} className="w-full flex flex-col items-center space-y-3">
            ...
            <div className="w-[260px] relative flex items-center">
              ...
              />
              <svg width="16" height="14" viewBox="0 0 16 14" fill="none" className="absolute left-2.5 text-[#4A4843] pointer-events-none">
            ...
            <div className="w-[260px] relative flex items-center">
              ...
              />
              <svg width="15" height="15" viewBox="0 0 16 16" fill="none" className="absolute left-2.5 text-[#4A4843] pointer-events-none">
          ...
          {/* Divider with "OR" */}
          <div className="w-[260px] flex flex-col items-center mt-5 mb-2.5">
            <div className="w-full h-[1px] bg-[#C5C0B4]"></div>
            <span className="text-[13px] font-comic text-[#75726B] -mt-2.5 bg-[#FBF8EF] px-2">
              OR
            </span>
          </div>

          {/* Social Logins */}
          <div className="w-[260px] flex justify-center mt-0.5">
            <button
